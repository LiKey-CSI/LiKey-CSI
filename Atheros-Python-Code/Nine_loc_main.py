...
# 第一步 加载数据集
# ----------------------------------------------------------------------------------
data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验4/data_feature/All_Loc_Feature/'
# data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验2/Circle/data_feature/All_Loc_Feature/'
# data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验2/Rectangle/data_feature/All_Loc_Feature/'
# data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验1/Size_1cm/data_feature_60/All_Loc_Feature/'
# data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验1/Size_1cm/data_feature_20/All_Loc_Feature/'
# data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验1/Size_2cm/data_feature_60/All_Loc_Feature/'
# data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验1/Size_4cm/data_feature_60/All_Loc_Feature/'

loc1_Rev1_data_path = data_path + 'loc1_Rev1_feature_mat.mat'
loc1_Rev2_data_path = data_path + 'loc1_Rev2_feature_mat.mat'
loc1_label_data_path = data_path + 'label.mat'
...
loc2_Rev1_data_path = data_path + 'loc2_Rev1_feature_mat.mat'
loc2_Rev2_data_path = data_path + 'loc2_Rev2_feature_mat.mat'
loc2_label_data_path = data_path + 'label.mat'
...
loc3_Rev1_data_path = data_path + 'loc3_Rev1_feature_mat.mat'
loc3_Rev2_data_path = data_path + 'loc3_Rev2_feature_mat.mat'
loc3_label_data_path = data_path + 'label.mat'
...
loc4_Rev1_data_path = data_path + 'loc4_Rev1_feature_mat.mat'
loc4_Rev2_data_path = data_path + 'loc4_Rev2_feature_mat.mat'
loc4_label_data_path = data_path + 'label.mat'
...
loc5_Rev1_data_path = data_path + 'loc5_Rev1_feature_mat.mat'
loc5_Rev2_data_path = data_path + 'loc5_Rev2_feature_mat.mat'
loc5_label_data_path = data_path + 'label.mat'
...
loc6_Rev1_data_path = data_path + 'loc6_Rev1_feature_mat.mat'
loc6_Rev2_data_path = data_path + 'loc6_Rev2_feature_mat.mat'
loc6_label_data_path = data_path + 'label.mat'
...
loc7_Rev1_data_path = data_path + 'loc7_Rev1_feature_mat.mat'
loc7_Rev2_data_path = data_path + 'loc7_Rev2_feature_mat.mat'
loc7_label_data_path = data_path + 'label.mat'
...
loc8_Rev1_data_path = data_path + 'loc8_Rev1_feature_mat.mat'
loc8_Rev2_data_path = data_path + 'loc8_Rev2_feature_mat.mat'
loc8_label_data_path = data_path + 'label.mat'
...
loc9_Rev1_data_path = data_path + 'loc9_Rev1_feature_mat.mat'
loc9_Rev2_data_path = data_path + 'loc9_Rev2_feature_mat.mat'
loc9_label_data_path = data_path + 'label.mat'
...
# Rev1_test_data = np.concatenate((loc2_Rev1_data, loc3_Rev1_data, loc4_Rev1_data, loc5_Rev1_data, loc6_Rev1_data, loc7_Rev1_data, loc8_Rev1_data, loc9_Rev1_data))
# Rev2_train_data = loc1_Rev2_data
# Rev2_test_data = np.concatenate((loc2_Rev2_data, loc3_Rev2_data, loc4_Rev2_data, loc5_Rev2_data, loc6_Rev2_data, loc7_Rev2_data, loc8_Rev2_data, loc9_Rev2_data))
# train_label = loc2_label_data
# test_label = np.concatenate((loc1_label_data, loc2_label_data, loc3_label_data, loc4_label_data, loc5_label_data, loc6_label_data, loc7_label_data, loc9_label_data))

# Rev1_train_data = np.concatenate((loc1_Rev1_data, loc9_Rev1_data))
# Rev1_test_data = np.concatenate((loc2_Rev1_data, loc3_Rev1_data, loc4_Rev1_data, loc5_Rev1_data, loc6_Rev1_data, loc7_Rev1_data, loc8_Rev1_data))
# Rev2_train_data = np.concatenate((loc1_Rev2_data, loc9_Rev2_data))
# Rev2_test_data = np.concatenate((loc2_Rev2_data, loc3_Rev2_data, loc4_Rev2_data, loc5_Rev2_data, loc6_Rev2_data, loc7_Rev2_data, loc8_Rev2_data))
# train_label = np.concatenate((loc1_label_data, loc5_label_data))
# test_label = np.concatenate((loc2_label_data, loc3_label_data, loc4_label_data, loc6_label_data, loc7_label_data, loc8_label_data, loc9_label_data))
...
# train_label = np.concatenate((loc7_label_data, loc8_label_data, loc9_label_data))
# test_label = np.concatenate((loc1_label_data, loc2_label_data, loc3_label_data, loc4_label_data, loc5_label_data, loc6_label_data))

# Rev1_train_data = np.concatenate((loc1_Rev1_data, loc4_Rev1_data, loc7_Rev1_data, loc9_Rev1_data))
# Rev1_test_data = np.concatenate((loc2_Rev1_data, loc3_Rev1_data, loc5_Rev1_data, loc6_Rev1_data, loc8_Rev1_data))
# Rev2_train_data = np.concatenate((loc1_Rev2_data, loc4_Rev2_data, loc7_Rev2_data, loc9_Rev2_data))
# Rev2_test_data = np.concatenate((loc2_Rev2_data, loc3_Rev2_data, loc5_Rev2_data, loc6_Rev2_data, loc8_Rev2_data))
# train_label = np.concatenate((loc1_label_data, loc2_label_data, loc3_label_data, loc4_label_data))
# test_label = np.concatenate((loc5_label_data, loc6_label_data, loc7_label_data, loc8_label_data, loc9_label_data))

# Rev1_train_data = np.concatenate((loc1_Rev1_data, loc2_Rev1_data, loc4_Rev1_data, loc7_Rev1_data, loc8_Rev1_data))
# Rev1_test_data = np.concatenate((loc3_Rev1_data, loc5_Rev1_data, loc6_Rev1_data, loc9_Rev1_data))
# Rev2_train_data = np.concatenate((loc1_Rev2_data, loc2_Rev2_data, loc4_Rev2_data, loc7_Rev2_data, loc8_Rev2_data))
# Rev2_test_data = np.concatenate((loc3_Rev2_data, loc5_Rev2_data, loc6_Rev2_data, loc9_Rev2_data))
# train_label = np.concatenate((loc1_label_data, loc2_label_data, loc3_label_data, loc4_label_data, loc5_label_data))
# test_label = np.concatenate((loc6_label_data, loc7_label_data, loc8_label_data, loc9_label_data))

# Rev1_train_data = np.concatenate((loc5_Rev1_data, loc6_Rev1_data, loc7_Rev1_data, loc9_Rev1_data, loc4_Rev1_data, loc8_Rev1_data))
# Rev1_test_data = np.concatenate((loc3_Rev1_data, loc1_Rev1_data, loc2_Rev1_data))
# Rev2_train_data = np.concatenate((loc5_Rev2_data, loc6_Rev2_data, loc7_Rev2_data, loc9_Rev2_data, loc4_Rev2_data, loc8_Rev2_data))
# Rev2_test_data = np.concatenate((loc3_Rev2_data, loc1_Rev2_data, loc2_Rev2_data))
# train_label = np.concatenate((loc5_label_data, loc6_label_data, loc7_label_data, loc9_label_data, loc4_label_data, loc8_label_data))
# test_label = np.concatenate((loc3_label_data, loc1_label_data, loc2_label_data))

Rev1_train_data = np.concatenate((loc2_Rev1_data, loc3_Rev1_data, loc4_Rev1_data, loc7_Rev1_data, loc8_Rev1_data, loc9_Rev1_data))
Rev1_test_data = np.concatenate((loc1_Rev1_data, loc5_Rev1_data, loc6_Rev1_data))
Rev2_train_data = np.concatenate((loc2_Rev2_data, loc3_Rev2_data, loc4_Rev2_data, loc7_Rev2_data, loc8_Rev2_data, loc9_Rev2_data))
Rev2_test_data = np.concatenate((loc1_Rev2_data, loc5_Rev2_data, loc6_Rev2_data))
train_label = np.concatenate((loc1_label_data, loc2_label_data, loc3_label_data, loc4_label_data, loc5_label_data, loc6_label_data))
test_label = np.concatenate((loc7_label_data, loc8_label_data, loc9_label_data))

# Rev1_train_data = np.concatenate((loc1_Rev1_data, loc6_Rev1_data, loc7_Rev1_data, loc5_Rev1_data, loc3_Rev1_data, loc4_Rev1_data))
# Rev1_test_data = np.concatenate((loc2_Rev1_data, loc8_Rev1_data, loc9_Rev1_data))
# Rev2_train_data = np.concatenate((loc1_Rev2_data, loc6_Rev2_data, loc7_Rev2_data, loc5_Rev2_data, loc3_Rev2_data, loc4_Rev2_data))
# Rev2_test_data = np.concatenate((loc2_Rev2_data, loc8_Rev2_data, loc9_Rev2_data))
# train_label = np.concatenate((loc1_label_data, loc6_label_data, loc7_label_data, loc5_label_data, loc3_label_data, loc4_label_data))
# test_label = np.concatenate((loc2_label_data, loc8_label_data, loc9_label_data))
