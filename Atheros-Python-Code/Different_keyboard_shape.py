...
# 该python代码 将一个键盘形状的数据作为训练，另一个键盘形状的数据作为测试

# ----------------------------------------------------------------------------------
# 第一步 加载训练数据集
# ----------------------------------------------------------------------------------
# train_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验4/data_feature/All_Loc_Feature/'
# train_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验2/Circle/data_feature/All_Loc_Feature/'
train_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验2/Rectangle/data_feature/All_Loc_Feature/'
...
test_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验2/Circle/data_feature/All_Loc_Feature/'
# test_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验4/data_feature/All_Loc_Feature/'
# test_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验2/Rectangle/data_feature/All_Loc_Feature/'
