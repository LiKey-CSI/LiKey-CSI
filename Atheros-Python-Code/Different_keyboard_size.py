...
# 该python代码 测试不同尺寸键盘下系统的性能表现

# ----------------------------------------------------------------------------------
# 第一步 加载训练数据集
# ----------------------------------------------------------------------------------
train_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验1/Size_1cm/data_feature_60/All_Loc_Feature/'
...
test_data_path = r'D:/Study/科研/LIKEY/补充实验/补充实验1/Size_2cm/data_feature_60/All_Loc_Feature/'
