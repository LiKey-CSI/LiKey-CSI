...
Rev1_train_data = np.concatenate((loc2_Rev1_data, loc4_Rev1_data, loc5_Rev1_data))
Rev1_test_data = np.concatenate((loc1_Rev1_data, loc3_Rev1_data))
Rev2_train_data = np.concatenate((loc2_Rev2_data, loc4_Rev2_data, loc5_Rev2_data))
Rev2_test_data = np.concatenate((loc1_Rev2_data, loc3_Rev2_data))
train_label = np.concatenate((loc2_label_data, loc4_label_data, loc5_label_data))
test_label = np.concatenate((loc1_label_data, loc3_label_data))
