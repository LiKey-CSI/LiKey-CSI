...
data_path = r'D:/Study/科研/LIKEY/原LiKey/数据特征/0704按键特征/location_sum'
# data_path = r'../0704按键特征/波形特征/location/振幅/'
# data_path = r'../0802按键特征/波形特征/location_振幅/'
...
Rev1_test_data = np.concatenate((loc3_Rev1_data, loc5_Rev1_data, loc4_Rev1_data))
Rev2_train_data = np.concatenate((loc1_Rev2_data, loc6_Rev2_data, loc7_Rev2_data, loc9_Rev2_data, loc2_Rev2_data, loc8_Rev2_data))
Rev2_test_data = np.concatenate((loc3_Rev2_data, loc5_Rev2_data, loc4_Rev2_data))
...
test_label = np.concatenate((loc3_label_data, loc5_label_data, loc4_label_data))
