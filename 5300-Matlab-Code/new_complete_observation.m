...
csi_trace1 = read_bf_file('./data0815/REV1/loc9_p999999_1.dat'); % 数据文件路径
csi_trace2 = read_bf_file('./data0815/REV2/loc9_p999999_1.dat'); % 数据文件路径
...
REV1_recomplie = abs_REV1_ratio_r1r2 .* exp(1i*phase_REV1_ratio_r1r2);%预处理重构后的复值
...
abs_REV2_ratio_r1r2 = func_sg(REV2_abs_ratio_r1r2);
phase_REV2_ratio_r1r2 = func_sg(REV2_phase_ratio_r1r2);

REV2_recomplie = abs_REV2_ratio_r1r2 .* exp(1i*phase_REV2_ratio_r1r2);%预处理重构后的复值
...
% feature_num = 60;
% for i = 1:length(merge_keypair)
%     start_index = merge_keypair(i,1);
%     end_index = merge_keypair(i,2);
